  ...
  return (
    ...
    bg-gray-800 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 border-2 border-gray-100 backdrop-saturate-150 w-full shadow-lg shadow-black/60">
        <div className="flex flex-col items-center w-full"> 
          ...
          <h1 className="font-Kanit uppercase font-bold text-[17px] md:text-2xl text-white bg-clip-text mt-0 text-center">
            ...
            { isAirdroping? 'Airdrop is Live!': isWLMint ? 'Whitelisted sale' : isPublicSale?'Public Sale' : 'Airdrops now Live!' }
            </h1>
